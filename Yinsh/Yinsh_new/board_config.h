...
{ 
    ...
    Node* tree(int N,int K,int cut_off);
    ...
    int eval_five(int N,int b1,int start_x,int start_y,int end_x,int end_y,int b2,int direction,int sign);
    // int eval_five(int N,int b1,int a1,int a2,int a3,int a4,int a5,int b2,int x1,int y1,int x2,int y2,int x3,int y3,int x4,int y4,int x5,int y5);
    //int eval_six(int N,int b1,int a1,int a2,int a3,int a4,int a5,int a6,int b2,int x1,int y1,int x2,int y2,int x3,int y3,int x4,int y4,int x5,int y5,int x6,int y6);
    int eval_six(int N,int b1,int start_x,int start_y,int end_x,int end_y,int b2,int direction,int sign);
    int each_ring(int N,int x, int y);

    int evaluate_heuristic(int N,int K);
